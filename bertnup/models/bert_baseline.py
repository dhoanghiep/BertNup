"""BERT-base-cased baseline model for nucleosome positioning prediction."""
...
class BertBaseline(BertNupBase):
    """Standard BERT-base-cased model with pooling and classification head.

    Used as a non-genomic baseline to demonstrate the value of DNA-specific
    pre-training. DNA sequences are tokenized character-by-character by
    BERT's WordPiece tokenizer (single characters are in vocab).
    """
